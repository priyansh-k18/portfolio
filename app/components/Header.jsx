  ...
  return (
    ...
    items-center justify-center gap-4'>
      ...
      <h3 className='flex items-end gap-2 text-xl md:text 2xl mb-3 font-ovo'>
        Hi! I'm Priyansh Keer <Image src={assets.hand_icon} alt=''
         className='w-6'/></h3>
         <h1 className='text-3xl sm:text-6xl lg:text-[66px] font-ovo'>
            fontend web developer based in India.</h1>
            <p className='max-w-2xl mx-auto font-Ovo'>
                I am a frontend developer from MP,India with some good project experience
                in multiple frontend framework react,js vanilla and nextjs.
            </p>
